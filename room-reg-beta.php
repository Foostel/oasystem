<!DOCTYPE html>
    ...
    <body style="background-color:#CFCFCF;" onclick="document.getElementById('search_res_list').innerHTML='';">
        ...
        <form class="form" style="position: relative; text-align:left;margin-left:20px;display: inline-block;" method="post" action="submit-room.php" enctype="multipart/form-data">
            
            <div class="form-container" style="width: 350px;">
                <input style="text-align: center; width: 300px;" id="b-name" type="" class="inputs" name="bn" placeholder="Service name" > 
            ...
            <div class="form-container" style="width: 350px;">
                ...
                <div style="display: inline-block; margin-right: 40px;">
                                Boys &nbsp<label for="b" style="position: absolute; margin-top: 3px; margin-left: 3px;" ><div  onclick="select(this,'room-type-label');" style="width:10px; height: 10px; border-style: none; border-radius: 50%; border:solid 5px white; background-color: white;" name="room-type-label"></div></label>
                                <input type="radio" name="gender" id="b" value="Boys">

                                Girls &nbsp<label for="g" style="position: absolute; margin-top: 3px; margin-left: 3px;" ><div  onclick="select(this,'room-type-label');" style="width:10px; height: 10px; border-style: none; border-radius: 50%; border:solid 5px white; background-color: white;" name="room-type-label"></div></label>
                                <input type="radio" name="gender" id ="g" value="Girls">
                                ...
                                <input type="radio" name="gender" id ="ao" value="Anyone">
                                ...
                                <input type="radio" name="work" id="st" value="Student">
                                ...
                                <input type="radio" name="work" id ="em" value="Employee">
                                ...
                                <input type="radio" name="work" id ="aon" value="Anyone">

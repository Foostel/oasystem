...
INSERT INTO `hostel_address` (`uid`, `cid`, `bn`, `bno`, `state`, `city`, `landmark`, `area`, `sarea`, `pincode`, `image`, `lng`, `lat`) VALUES
(11125, 1, 'Rai Hostel', '4', 'madhya pradesh', 'indore', 'Behind Malhar', 'Vijay Nagar, Indore, Indore, Madhya Pradesh, India', 'vijay nagar, indore, indore, madhya pradesh, india behind malhar', 452001, NULL, '75.89912690842652', '22.75231826186601'),
(11125, 6, 'Yk Hostel', '155A', 'madhya pradesh', 'indore', 'Behind Zoo', 'Indore Zoo, A. B. Road, Indore, Madhya Pradesh, India', 'indore zoo, a. b. road, indore, madhya pradesh, india behind zoo', 452001, NULL, '75.88631046047635', '22.713802624252125');
...
INSERT INTO `room_address` (`uid`, `cid`, `bn`, `bno`, `state`, `city`, `landmark`, `area`, `sarea`, `pincode`, `image`, `lng`, `lat`) VALUES
(11125, 11269, 'Farzi Rooms', '45', 'madhya pradesh', 'indore', 'Geeta Bhavan', 'Geeta Bhavan Square, AB Rd, Indore, Madhya Pradesh, India', 'geeta bhavan square, ab rd, indore, madhya pradesh, india geeta bhavan', 521452, NULL, '75.88427230535876', '22.718006052574538'),
(11125, 11273, 'Roomer Rooms', '199', 'madhya pradesh', 'chhindwara', 'Behind ram mandir ', 'chhoti bazar ram mandir', 'chhoti bazar ram mandir behind ram mandir', 480001, NULL, '78.9452211184622', '22.055471378981622'),
(11125, 11274, 'Lala Rooms', '45', 'madhya pradesh', 'indore', 'Near Rajwada Chowk', 'Rajwada, Rajwada Chouk, Indore, Madhya Pradesh, India', 'rajwada, rajwada chouk, indore, madhya pradesh, india near rajwada chowk', 452001, NULL, '75.86450180435622', '22.717519131721332'),
(11125, 11275, 'Rovert Rooms', '154', 'madhya pradesh', 'bhopal', 'Near main road', 'BHEL, Bhopal, Bhopal, Madhya Pradesh, India', 'bhel, bhopal, bhopal, madhya pradesh, india near main road', 101010, NULL, '77.45994437559716', '23.229566968057057'),
(11125, 11276, 'Akash Room service', '24A', 'maharashtra', 'nagpur', 'Near central mall', 'Nagpur Central Mall, Nagpur, Maharashtra, India', 'nagpur central mall, nagpur, maharashtra, india near central mall', 458712, NULL, '79.0954862879405', '21.151119225472954'),
(11125, 11277, 'Rajore Rooms', '58AX', 'madhya pradesh', 'indore', 'Near Saket Square', 'Anand Bazar, Near Saket Square, Indore, Madhya Pradesh, India', 'anand bazar, near saket square, indore, madhya pradesh, india near saket square', 452001, NULL, '75.89472975126091', '22.726718175995543');
...
INSERT INTO `tiffin_address` (`uid`, `cid`, `bn`, `bno`, `state`, `city`, `landmark`, `area`, `sarea`, `pincode`, `image`, `lng`, `lat`) VALUES
...
(11125, 10058, 'Rai bakery', '45', 'madhya pradesh', 'chhindwara', 'Khajri Road', 'Teachers Colony, Chhindwara, Chhindwara, Madhya Pradesh, India', 'teachers colony, chhindwara, chhindwara, madhya pradesh, india khajri road', '480001', '', '78.93399714064572', '22.073164906750037');
...
(11125, 10058, 0, '01AM,to,01AM,,', 0, '01AM,to,01AM,,', 1, '07PM,to,10PM,1000,Monthly', 0, 1, 0, 1000);
...
INSERT INTO `user` (`id`, `fname`, `lname`, `gender`, `age`, `phone`, `email`, `password`, `pp`, `OA`) VALUES
(11125, 'Mihir', 'Soni', 'Male', 20, '919753621953', 'msonii2000@gmail.com', '83f714e18dcf081ad6d8328211185436', './files/user/11125_PP.jpg', 0),
(11130, 'Mihir', 'Shots', 'Male', 20, '919753621953', 'shots.mihir@gmail.com', '83f714e18dcf081ad6d8328211185436', './files/user/0000_PP.jpg', 0);
...
--
ALTER TABLE `tiffin_address`
  MODIFY `cid` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10059;
...
--
ALTER TABLE `user`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11131;
COMMIT;

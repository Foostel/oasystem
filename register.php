        ...
        <div id="register">
            ...
            <form>
                <table cellspacing="20px" cellpadding="5px" style="border-top:solid">
                    ...
                    <tr><td>Phone: </td> <td><input  style="width: 200px; height: 30px; margin: 0px;" class="inputs" name="phoneno" id="phoneno" required=""></td> <td>Email: </td> <td><input  class="inputs" type="Email" style="width: 200px; margin: 0px; height: 30px;"> </td></tr>
            ...
            <input type="submit" class="btn" name="" value="Submit" onsubmit="validate()">
            </form>
            <br>
            <form>

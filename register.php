...
<body style="background-color: #E9E9E9;">
    ...
    <div class="section" onclick="if(!h){toggle('pop-up');}">
        <div id="register">
            ...
            <form onsubmit="return validate();" method="post" action="submit-reg.php">
                <table cellspacing="20px" cellpadding="5px" style="border-top:solid" width="1000px;">
                    <tr><td>First Name: </td> <td><input autocomplete="" style="width: 200px; height: 30px; margin: 0px;" class="inputs" type="text" name="" required=""></td> <td>Last Name:</td> <td><input class="inputs" style="width: 200px; margin: 0px; height: 30px; "type="text" name=""></td></tr>
                    ...
                    <tr><td>Phone: </td> <td>
                        ...
                        <input  style="width: 100px; height: 30px; margin: 0px; " class="inputs" name="phoneno" id="phoneno" required=""></td> <td>Email: </td> <td><input  class="inputs" type="Email" style="width: 200px; margin: 0px; height: 30px;"> </td></tr>

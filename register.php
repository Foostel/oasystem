        ...
        <div class="section" onclick="if(!h){toggle('pop-up');}" >
            <div id="register">
            	...
            	<table cellspacing="20px" cellpadding="5px" style="border-top:solid">
            		...
            		<tr><td>Gender: </td> <td>Male<input  type="radio" name="Gender" value="Male" required=""> Female<input type="radio" value="Female" name="Gender" required=""></td> <td>Age: </td> <td><input  class="inputs" type="number" name=" " style="width: 200px; margin: 0px; height: 30px;" required=""> </td></tr>

            		<tr><td>Phone: </td> <td><input  style="width: 200px; height: 30px; margin: 0px;" class="inputs" type="Phone" name="" required=""></td> <td>Email: </td> <td><input  class="inputs" type="Email" style="width: 200px; margin: 0px; height: 30px;"> </td></tr>

<!DOCTYPE html>
    ...
    <body style="background-color:#CFCFCF;" onclick="document.getElementById('search_res_list').innerHTML='';">
        ...
        <form onsubmit="return validateF();" class="form" style="position: relative; text-align:left;margin-left:20px;display: inline-block; font-size: 13px;" method="post" action="submit-room.php" enctype="multipart/form-data" >
            
            <div class="form-container" style="width: 230px;">
                <input style="text-align: center; width: 200px;" id="b-name" type="" class="inputs" name="bn" placeholder="Service name" required="">
                <input style="text-align: center; width: 200px;" id="h-no" type="" class="inputs" name="b" placeholder="Building/House no" required="">  
                <select required="" style="height: 50px; width: 210px;text-align: center;" class="inputs" onchange="print_city('state', this.selectedIndex);" id="sts" name ="s" class="form-control" required></select>
                <script language="javascript">print_state("sts");</script>
                <select required="" style="height: 50px;width: 210px; text-align: center;" class="inputs" id ="state" name="c" class="form-control" required></select>
                <script type="text/javascript" src="area.js"></script>
                <input required="" autocomplete="off" id="search_input" style="text-align: center; width: 200px;" type="" class="inputs" name="a" placeholder="Area/Coloney/Street" onkeyup="getin();" >
            ...
            <div class="form-container" style="width: 300px;">
                <input required="" id="pc" style="text-align: center; width: 200px;" type="" class="inputs" name="p" placeholder="Pincode" >
                <script type="text/javascript">
                            function pop(id)
                ...
                <button id="geo-l" onclick="pop('pop-up');" style="text-align: center; width: 210px; height: 50px; cursor: pointer;" type="button" class="inputs" name="loc">
                    ...
                    <div class="overlays pop-up" id="pop-up" style="width: 300px; height: 400px; display:none;text-align:center; position: absolute;">
            ...
            <div class="form-container" style="width: 280px;" >
            ...
            <div class="form-container" style="width: 350px; height: 200px;">
                <b>Rules </b> <hr style="border:solid .5px;"><textarea style="width: 200px; border: none; height: 100px; font-family: segoe UI; font-size: 13px;" placeholder="Write here"></textarea>               
            </div>
                  
            <br><br>

            <div style="height:50px; position: relative; float: left; margin-bottom: 50px;">
            I accept <a href="" style="text-decoration: underline; color:blue;">Terms & conditions</a>
            <div style="display: inline-block;  margin-bottom: 17px;">
            ...
            <br><br>
            <input style="position:relative;width:200px;"  type="submit" value="Submit" class="btn" name="submit" onclick="">
            </div>
